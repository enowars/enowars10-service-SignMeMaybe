SignMeMaybe service
====================
Contract Workflow service to provide students a project strucutre. SignMeMaybe is a simple service that allows users to register, login and save/retrieve notes. 
